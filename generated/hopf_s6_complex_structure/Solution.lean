...
@[reducible] noncomputable instance instChartedSpaceS6 :
    ChartedSpace (Fin 3 → ℂ)
      (Metric.sphere (0 : EuclideanSpace ℝ (Fin 7)) 1) := Submission.instChartedSpaceS6
...
instance instIsManifoldS6 :
    IsManifold 𝓘(ℂ, Fin 3 → ℂ) ω
      (Metric.sphere (0 : EuclideanSpace ℝ (Fin 7)) 1) := Submission.instIsManifoldS6
